...
This repository contains the Swiss NextGen API, the adapted version of the NextGenPSD2 XS2A Framework of the the [Berlin Group](https://github.com/openbankingproject-ch/obp-apis) with the Swiss Domestic Payment Definitions. The API
