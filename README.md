...
This repository contains the Swiss NextGen API, the adapted version of the NextGenPSD2 XS2A Framework of the the [Berlin Group](https://openbankingproject-ch.github.io/obp-apis/berlin-group.html) with the Swiss Domestic Payment Definitions. The API
